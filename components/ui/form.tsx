...
/**
 * shadcn/ui-style Form helpers wired to react-hook-form.
 * Use <Form> as <FormProvider>, then compose <FormField>, <FormItem>,
...
>(({ className, children, ...props }, ref) => {
  ...
  return (
    <p
      ref={ref}
      id={formMessageId}
      className={cn('text-xs text-brand-danger', className)}
      {...props}
    >
      {body}
    </p>
